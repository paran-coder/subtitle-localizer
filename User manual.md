...
v1.7.0 보완 후, 업로드 대상 영상이 현재 `YouTube 자막` 원본 영상과 같다면 새 자막 트랙 목록을 자동으로 다시 불러옵니다. 다른 영상으로 갔다가 돌아오는 수동 새로고침이 필요하지 않아야 합니다.
...
6. 성공 상태에서 언어, cue 수, 영상 제목/생성된 원본 파일명을 확인합니다.
