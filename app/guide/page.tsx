    ...
    <div className="guide-layout">
      ...
      <div className="guide-content">
        ...
        <section id="youtube" className="guide-section">
          ...
          <div className="guide-callout is-orange"><strong>최초 1회 설정</strong><p>아래 8단계를 한 번 완료하면 정상적인 추가 Google 계정/YouTube 채널 연결 때문에 프로젝트·API·OAuth Client를 다시 만들 필요가 없습니다.</p><a href="/connections?setup=youtube&return=/guide">앱의 8단계 마법사와 함께 진행 →</a></div>
          ...
          <div className="guide-steps">
            ...
            <Step number={7} title="Client ID와 Client Secret을 앱에 저장합니다."><p>Google이 발급한 값을 `연결 관리`의 7단계 입력칸에 넣습니다. Client Secret 역시 실제 값을 문서·GitHub·스크린샷에 남기지 않습니다.</p><a className="guide-action-link" href="/connections?setup=youtube&return=/guide">연결 관리 7단계로 이동 →</a><p className="guide-complete">완료 기준 · 앱이 `Cloud Client를 저장했습니다` 상태로 넘어갑니다.</p></Step>
